...
export default function BloodAcceptor() {
                        ...
                        <div className="grid md:grid-cols-4 grid-cols-1">
                            {
                                ...
                                getData.filter((blood: any) => blood.role == 'Acceptor').map((x: any, i: any) => {
                                    return (
                                        <div className="bg-black m-3 border  border-white text-center  rounded-md p-5 hover:transition-all flex flex-col items-center">
